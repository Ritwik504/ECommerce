...
public class UserServiceImpl implements IUserService {
	...
	public User authenticateUser(String em, String pass) {
		...
		return userDao.findByEmailAndPass(em, pass).orElseThrow(()-> new RuntimeException("Invalid Email or Password"));
	}
	...
	@Override
	public void saveChat(String msg, User user) {
//		User temp = userDao.getById(user.getId());
		User temp = userDao.getById((long)1);
		temp.setMessage(msg);
	}
